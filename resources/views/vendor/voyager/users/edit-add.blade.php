                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($dataTypeContent->active) || old($dataTypeContent->active))
                                    <?php $checked = old($dataTypeContent->active, $dataTypeContent->active); ?>
                                @else
                                    <?php $checked = isset($dataTypeContent->active) &&
                                    filter_var($dataTypeContent->active, FILTER_VALIDATE_BOOLEAN) ? true: false; ?>
                                @endif

                                <?php $class = $options->class ?? "toggleswitch"; ?>

                                @if( isset($options->on) && isset($options->off) )
                                    <input id="active" type="checkbox" name="active" class="{{ $class }}"

                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" required>
                                    ...
                                    @if (\App\PostCategory::all()->count() > 0)
                                        @foreach(\App\PostCategory::all() as $category)
                                            <option value="{{ $category->id }}"@if(isset($dataTypeContent->category_id) && $dataTypeContent->category_id == $category->id) selected="selected"@endif>{{ $category->getTranslatedAttribute('name') }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
